...
spark = SparkSession.bulder \
    .appNmae('Advanced Credid Card Transactions Processor') \
    .getOrCreate()

# Path to JSON files in Google Cloud Storage
json_file_path = "gs://credit_card_data_analysis_ritayan/transactions/transactions_*.json"

# Define BigQuery Dataset & Table Names
BQ_PROJECT_ID = "computer-systems-ritayan-patra"
BQ_DATASET = "credit_card_info_ritayan"
